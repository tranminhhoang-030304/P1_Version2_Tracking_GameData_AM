...
export function Sidebar() {
  ...
  return (
    // THAY ĐỔI LỚN Ở DÒNG NÀY:
    // 1. 'fixed': Cố định vị trí, không trôi khi cuộn chuột.
    // 2. 'inset-y-0': Kéo dài từ đỉnh xuống đáy màn hình (Top 0, Bottom 0).
    // 3. 'left-0': Dính chặt lề trái.
    // 4. 'z-50': Luôn nằm trên cùng (để không bị nội dung khác che mất).
    // 5. 'w-64': Chiều rộng cố định (256px).
